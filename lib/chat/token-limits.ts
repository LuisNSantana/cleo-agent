...
export function clampMaxOutputTokens(modelId: string, requested?: number): number {
  ...
  else if (id.startsWith('gpt-5.1')) cap = 128000 // GPT-5.1 supports 128K output tokens
  else if (id.startsWith('gpt-5')) cap = 32768 // GPT-5 mini/nano have lower limits
  ...
  else if (id.includes('grok-4')) cap = 32768 // Grok 4 supports higher output
