...
export const openrouterModels: ModelConfig[] = [
  ...
  {
    id: "openrouter:qwen/qwen2.5-32b-instruct",
    ...
    baseProviderId: "qwen",
    description:
      "Instruction-tuned Qwen2.5 32B. Strong general performance and coding/math, excellent value.",
    tags: ["cost-effective", "instruction", "coding", "reasoning"],
    ...
    intelligence: "High",
    website: "https://openrouter.ai",
    apiDocs: "https://openrouter.ai/qwen/qwen2.5-32b-instruct",
    modelPage: "https://github.com/QwenLM",
