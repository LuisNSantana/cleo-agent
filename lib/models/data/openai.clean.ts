...
const openaiModels: ModelConfig[] = [
  {
    ...
    description:
      "Ultra-fast lightweight GPT-5 Nano model with vision capabilities for low-latency tasks and tools.",
    tags: ["openai", "nano", "fast", "tools", "vision"],
  ...
  },
  {
    ...
    baseProviderId: "openai",
    description:
      "A faster, cost-efficient multimodal version of GPT-5. Great for well-defined tasks and precise prompts with enhanced reasoning and vision capabilities.",
    tags: ["openai", "mini", "fast", "tools", "reasoning", "vision"],
