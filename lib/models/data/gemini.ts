...
const geminiModels: ModelConfig[] = [
  ...
  },
  {
    ...
    modelFamily: "Gemini",
    baseProviderId: "google",
    description: "Gemini's text-to-image generation model (Nano Banana). Creates high-quality images from text descriptions with fast processing.",
    ...
    modelPage: "https://gemini.google/overview/image-generation/",
    releasedAt: "2025-08-01",
    dailyLimit: 5,
    icon: "gemini",
    apiSdk: (apiKey?: string) =>
      openproviders("gemini-2.5-flash-image-preview", undefined, apiKey),
  },
  {
