...
import { X, ChevronRight, Calendar, Info } from 'lucide-react'
import { 
  TASK_PRESETS, 
  PRESET_CATEGORIES, 
  getPresetById,
        ...
        <div className="p-6 border-b border-border flex items-center justify-between">
          <div>
            <h2 className="text-xl font-semibold text-foreground">
              {step === 'preset' ? 'Choose a Template' : 'Task Details'}
            </h2>
              ...
              >
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g., Research AI trends, Send weekly report..."
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    💡 Be specific: include recipients for emails, URLs for research, dates/times for events
                  </p>
                </div>

                {/* Schedule (Simple Mode) */}
                {!advancedMode && (
                  <div>
                    <label className="block text-sm font-medium text-muted-foreground mb-2">
