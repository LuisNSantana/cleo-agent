      ...
      <TabsContent value="basic" className="space-y-3 sm:space-y-4">
          ...
          <CardContent className="pt-4">
            {(() => {
              ...
              const avatar = name.includes('toby') ? '/img/agents/toby4.png'
                ...
                : (name.includes('cleo') || name.includes('kylio')) ? '/img/agents/cleo4.png'
                : '/img/agents/cleo4.png'
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          ...
          <div className="space-y-2">
                  ...
                  <SelectContent className="bg-slate-800 text-white border-slate-700 max-h-64">
                    ...
                    {uuidAgents.map((a) => {
                      ...
                      const avatar = (a.avatar)
                        ...
                        : (lower.includes('cleo') || lower.includes('kylio')) ? '/img/agents/cleo4.png'
                        : '/img/agents/cleo4.png')
                      return (
            ...
            {formData.parentAgentId && (() => { const pAny: any = (agents.find(x => x.id === formData.parentAgentId) as any) || (parentCandidates.find((pc:any)=>pc.id===formData.parentAgentId) as any); if (!pAny) return null; const lower=(pAny.name||'').toLowerCase(); const avatar = pAny.avatar || (lower.includes('toby') ? '/img/agents/toby4.png' : lower.includes('ami') ? '/img/agents/ami4.png' : lower.includes('peter') ? '/img/agents/peter4.png' : lower.includes('emma') ? '/img/agents/emma4.png' : lower.includes('apu') ? '/img/agents/apu4.png' : lower.includes('wex') ? '/img/agents/wex4.png' : (lower.includes('cleo') || lower.includes('kylio')) ? '/img/agents/cleo4.png' : '/img/agents/cleo4.png'); return (
...
export function AgentCRUDPanel({ agents, onCreateAgent, onUpdateAgent, onDeleteAgent }: AgentCRUDPanelProps) {
  ...
  if (key.includes('cleo') || key.includes('kylio')) return '/img/agents/cleo4.png'
