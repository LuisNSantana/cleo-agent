...
function DrawerContent({
  className,
  children,
  srTitle = "Drawer panel",
  ensureTitle = true,
  ...props
}: React.ComponentProps<typeof DrawerPrimitive.Content> & { srTitle?: string; ensureTitle?: boolean }) {
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-background fixed z-50 flex h-auto max-h-[85svh] flex-col min-h-0",
